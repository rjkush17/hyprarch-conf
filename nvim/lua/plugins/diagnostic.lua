return {
    ...
    },
    {
        ...
        opts = {
            -- comment: set default window position to RIGHT for all modes
            win = {
                position = "right",
                size = 60,
                wrap = true,
        ...
        config = function(_, opts)
            ...
            -- comment: apply user options
            trouble.setup(opts)

            -- comment: keymaps
            vim.keymap.set("n", "<leader>do", "<cmd>Trouble diagnostics<CR>", {
                desc = "Open Diagnostics Right Sidebar",
            })
            ...
            vim.keymap.set("n", "<leader>dx", "<cmd:Trouble diagnostics toggle filter=buffer<CR>", {
                desc = "Document Diagnostics",
            })

            vim.keymap.set("n", "<leader>xr", "<cmd>Trouble lsp toggle focus=true<CR>", {
                desc = "LSP References Right",
            })
        end,
    },
}
